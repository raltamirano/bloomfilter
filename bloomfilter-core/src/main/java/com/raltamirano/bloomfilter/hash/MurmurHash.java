 ...
 * @version 1.0.2
 *
 * raltamirano: Found @ https://github.com/tnm/murmurhash-java/blob/master/src/main/java/ie/ucd/murmur/MurmurHash.java
 */
public final class MurmurHash implements HashFunction {
	...
	public int getHash(byte[] data) {
		return MurmurHash.hash32(data, data.length);
	}
}
